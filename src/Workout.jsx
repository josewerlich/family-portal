...
const ICON = {
  ...
  cableRowStart: svgIcon(`<line x1="12" y1="82" x2="34" y2="82"/><rect x="34" y="73" width="18" height="8"/><circle cx="95" cy="18" r="4" fill="#3df0c8"/><line x1="95" y1="10" x2="95" y2="55"/><path d="M58 45 L85 48" stroke-width="3"/><circle cx="58" cy="42" r="7"/><path d="M58 49 L48 68"/><path d="M48 68 L30 74 M48 68 L18 80"/>`),
  cableRowEnd: svgIcon(`<line x1="12" y1="82" x2="34" y2="82"/><rect x="34" y="73" width="18" height="8"/><circle cx="95" cy="18" r="4" fill="#3df0c8"/><line x1="95" y1="10" x2="95" y2="55"/><path d="M60 52 L78 55 L60 58" stroke-width="3"/><circle cx="60" cy="40" r="7"/><path d="M60 47 L48 68"/><path d="M48 68 L30 74 M48 68 L18 80"/>`),
  legExtStart: svgIcon(`<line x1="15" y1="18" x2="15" y2="82"/><rect x="20" y="72" width="20" height="10"/><circle cx="42" cy="26" r="7"/><path d="M42 33 L42 60"/><path d="M42 60 L68 62"/><path d="M68 62 L68 90"/><circle cx="68" cy="90" r="6"/>`),
  legExtEnd: svgIcon(`<line x1="15" y1="18" x2="15" y2="82"/><rect x="20" y="72" width="20" height="10"/><circle cx="42" cy="26" r="7"/><path d="M42 33 L42 60"/><path d="M42 60 L70 58"/><path d="M70 58 L102 44"/><circle cx="102" cy="44" r="6"/>`),
};
...
const I = {
  ...
  'cable-row':       [ICON.cableRowStart,ICON.cableRowEnd],
  'leg-extension':   [ICON.legExtStart,ICON.legExtEnd],
};
...
const DAYS = [
  ...
  {id:'day3',label:'FRI',full:'CARDIO + CORE',sub:'Friday · 7:30–8:30 AM',dow:5,pills:['4 Exercises','~45 min','Cardio day'],
   items:[{t:'ex',id:'bike',time:'7:30'},{t:'rest',dur:60,label:'Quick rest'},{t:'ex',id:'plank',time:'7:47'},{t:'rest',dur:60,label:'Rest'},{t:'ex',id:'leg-raises',time:'7:52'},{t:'rest',dur:60,label:'Rest'},{t:'ex',id:'crunches',time:'7:57'},{t:'label',text:'8:04 AM · COOL DOWN',sub:'Full body stretch — 8 min'}]},
