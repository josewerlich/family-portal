...
const DAYS = [
  {id:'day1',label:'TUE',full:'UPPER BODY',sub:'Tuesday · 6:30–7:30 AM',dow:2,pills:['7 Exercises','~65 min','Upper focus'],
   items:[{t:'label',text:'6:30 AM · WARM UP',sub:'Arm circles, shoulder rolls — 3 min'},{t:'ex',id:'chest-press',time:'6:33'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'dumbbell-row',time:'6:40'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'lat-pulldown',time:'6:47'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'shoulder-press',time:'6:54'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'bicep-curl',time:'7:01'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'tricep-pushdown',time:'7:08'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'cable-row',time:'7:13'},{t:'label',text:'7:18 AM · COOL DOWN',sub:'Stretch arms & chest — 10 min'}]},
  {id:'day2',label:'THU',full:'LOWER BODY',sub:'Thursday · 6:30–7:30 AM',dow:4,pills:['6 Exercises','~65 min','Leg focus'],
   items:[{t:'label',text:'6:30 AM · WARM UP',sub:'Leg swings, hip circles — 3 min'},{t:'ex',id:'goblet-squat',time:'6:33'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'rdl',time:'6:41'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'reverse-lunge',time:'6:49'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'step-up',time:'6:57'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'calf-raises',time:'7:05'},{t:'rest',dur:90,label:'Rest between sets'},{t:'ex',id:'leg-extension',time:'7:10'},{t:'label',text:'7:15 AM · COOL DOWN',sub:'Hamstring & quad stretch — 10 min'}]},
  {id:'day3',label:'FRI',full:'CARDIO + CORE',sub:'Friday · 6:30–7:30 AM',dow:5,pills:['6 Exercises','~60 min','Cardio day'],
   items:[{t:'ex',id:'rowing',time:'6:30'},{t:'rest',dur:60,label:'Quick rest'},{t:'ex',id:'bike',time:'6:41'},{t:'rest',dur:60,label:'Quick rest'},{t:'ex',id:'punching-bag',time:'6:57'},{t:'rest',dur:60,label:'Rest'},{t:'ex',id:'plank',time:'7:05'},{t:'rest',dur:60,label:'Rest'},{t:'ex',id:'leg-raises',time:'7:10'},{t:'rest',dur:60,label:'Rest'},{t:'ex',id:'crunches',time:'7:15'},{t:'label',text:'7:22 AM · COOL DOWN',sub:'Full body stretch — 8 min'}]},
  {id:'day4',label:'SUN',full:'FULL BODY CIRCUIT',sub:'Sunday · 6:30–7:30 AM',dow:0,pills:['6 Exercises','3 Rounds','60s rest between rounds'],
   items:[{t:'label',text:'6:30 AM · WARM UP',sub:'5 min light cardio'},{t:'label',text:'6:35 AM · ROUND 1 OF 3',sub:''},{t:'ex',id:'goblet-squat',time:'6:35'},{t:'ex',id:'dumbbell-row',time:'6:38'},{t:'ex',id:'chest-press',time:'6:41'},{t:'ex',id:'lat-pulldown',time:'6:44'},{t:'ex',id:'reverse-lunge',time:'6:47'},{t:'ex',id:'plank',time:'6:50'},{t:'rest',dur:60,label:'Rest between rounds'},{t:'label',text:'6:52 AM · ROUND 2 OF 3',sub:''},{t:'ex',id:'goblet-squat',time:'6:52'},{t:'ex',id:'dumbbell-row',time:'6:55'},{t:'ex',id:'chest-press',time:'6:58'},{t:'ex',id:'lat-pulldown',time:'7:01'},{t:'ex',id:'reverse-lunge',time:'7:04'},{t:'ex',id:'plank',time:'7:07'},{t:'rest',dur:60,label:'Rest between rounds'},{t:'label',text:'7:09 AM · ROUND 3 OF 3',sub:''},{t:'ex',id:'goblet-squat',time:'7:09'},{t:'ex',id:'dumbbell-row',time:'7:12'},{t:'ex',id:'chest-press',time:'7:15'},{t:'ex',id:'lat-pulldown',time:'7:18'},{t:'ex',id:'reverse-lunge',time:'7:21'},{t:'ex',id:'plank',time:'7:24'},{t:'label',text:'7:27 AM · COOL DOWN',sub:'Full body stretch — 8 min'}]},
];
